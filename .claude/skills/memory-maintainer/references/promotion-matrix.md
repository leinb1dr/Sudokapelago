...
- "DPR-1790 is merged, idempotent Archipelago location checks is done" → `progress.md`
- "from now on, always filter ConsistencyErrors by source before any update" → `.claude/rules/archipelago.md`
